 ...
 * 
 */
@WebServiceClient(name = "MyWebServiceService", targetNamespace = "http://is_project3/", wsdlLocation = "http://localhost:8081/webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICESERVICE_QNAME = new QName("http://is_project3/", "MyWebServiceService");
    ...
    public MyWebService getMyWebServicePort() {
        return super.getPort(new QName("http://is_project3/", "MyWebServicePort"), MyWebService.class);
    }
    ...
    public MyWebService getMyWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://is_project3/", "MyWebServicePort"), MyWebService.class, features);
    }
