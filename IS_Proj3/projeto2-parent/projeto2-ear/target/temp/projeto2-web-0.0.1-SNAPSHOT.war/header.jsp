	...
	<body>
		...
		<div class="container navbar-more visible-xs">
			...
			<ul class="nav navbar-nav">
				<li>
					<a href="http://localhost:8081/listUsers">
				...
				<li>
					<div class="dropdown">
						<i class="menu-icon fa fa-eye" aria-hidden="true"></i>
					 	Subscribe Cars
					  <div class="dropdown-content">
					  	<a href="./SubscribeCar">Subscribe Car</a></br>
					    <a href="./UnsubscribeCar">Unsubscribe Car</a></br>
					    <a href="http://localhost:8081/listSubscriptions">List Subscriptions</a>
					  </div>
					</div>
				</li>
				<li>
