...
public class MessageBean implements MessageListener {
    ...
    public void addCarsToDB(ArrayList<CarXML> carCatalog) {
        ...
        if(q.getResultList().isEmpty()) {
        		...
        		String distance = ""+carCatalog.get(i).getDistanceInfo().getValue();
        		String power = ""+carCatalog.get(i).getPowerInfo().getValue();
        		String cylinderCapacity = ""+carCatalog.get(i).getCCInfo().getValue();
        		String price = ""+carCatalog.get(i).getPriceInfo().getValue();
        		...
        		em.persist(new Car(imageURL, brand, model, fuel, registerDate, distance, power, cylinderCapacity, price, u));
            }
    	}
    }
}
